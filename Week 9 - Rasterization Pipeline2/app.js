...
function createScene() {
    ...
    var translationMatrix = new Matrix4().makeTranslation(0, -1, -10); 
    var scaleMatrix = new Matrix4().makeScale(10, 10, 10);
    var rotationMatrix = new Matrix4().makeRotationX(-90);
    groundGeometry.worldMatrix = translationMatrix.multiply(rotationMatrix).multiply(scaleMatrix);
    // groundGeometry.worldMatrix = scaleMatrix.multiply(rotationMatrix).multiply(translationMatrix);
    ...
    var sphereScaleMatrix = new Matrix4().makeScale(0.01, 0.01, 0.01);
    var sphereTranslationMatrix = new Matrix4().makeTranslation(0, 0, -5);
    sphereGeometry.worldMatrix = sphereTranslationMatrix.multiply(sphereScaleMatrix);
