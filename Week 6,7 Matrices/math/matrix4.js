...
var Matrix4 = function (x, y, z) {
 ...
 Matrix4.prototype = {
  ...
  var x, y, z;
  if (arg1 instanceof Vector3 || arg1 instanceof Vector4) {
  x = arg1.x;
  y = arg1.y;
  z = arg1.z;
  } else {
  ...
  e[0] = -2 * lr; e[1] = 0; e[2] = 0; e[3] = (left + right) * lr;
  e[4] = 0; e[5] = -2 * bt; e[6] = 0; e[7] = (top + bottom) * bt;
  e[8] = 0; e[9] = 0; e[10] = 2 * nf; e[11] = (far + near) * nf;
  e[12] = 0; e[13] = 0; e[14] = 0; e[15] = 1;
  ...
  var sMatrix = new Matrix4().makeScale(scale.x, scale.y, scale.z);
  var rMatrix = new Matrix4().copy(rotation);
  var tMatrix = new Matrix4().makeTranslation(translation.x, translation.y, translation.z);
  ...
  var moonRotationMatrix = new Matrix4().makeRotationZ(currentRotationAngle);
  
  var moonTranslationMatrix = new Matrix4().makeTranslation(offsetFromEarth.x, offsetFromEarth.y, offsetFromEarth.z);
 
  var moonMatrix = new Matrix4();
  moonMatrix.multiply(moonRotationMatrix).multiply(moonTranslationMatrix);
